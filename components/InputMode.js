...
export default function InputMode({ inputMode, setInputMode }) {
  return (
    <div className="flex items-center space-x-2 py-2 px-2 backdrop-blur-sm bg-white/80 rounded-full h-full">
          <button
            className={`flex items-center gap-2 px-4 py-2 rounded-full h-full ${
